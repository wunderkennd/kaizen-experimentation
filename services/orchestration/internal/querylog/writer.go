...
// Every Spark SQL query is logged to PostgreSQL's query_log table (see 001_schema.sql).
// This feeds the UI's 'View SQL' and 'Export to Notebook' features.
package querylog
...
type Entry struct {
	...
	RowCount     int64
	DurationMs   int64
	JobType      string // "daily_metric", "hourly_guardrail", "ratio_computation", etc.
...
// MemWriter is an in-memory Writer for development and testing.
