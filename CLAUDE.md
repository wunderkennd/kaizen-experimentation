...
| **Harness modernization proposal (H0–H8)** | `docs/coordination/harness-modernization-proposal.md` — phase status annotations, prior-art revisions, open questions |
