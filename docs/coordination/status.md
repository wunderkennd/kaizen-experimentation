...
| Agent-5 | M5 Management | 🔵 Phase 2 | agent-5/feat/surrogate-crud | Surrogate model CRUD (Phase 2) | — | Surrogate model CRUD complete. Unblocks Agent-3 (M2.10 surrogate metric computation), Agent-6 (surrogate projection UI). |
