...
> **Last updated**: 2026-03-15 by Agent-4 (chaos hardening: chaos_kill_policy.sh implemented, chaos_test_analysis.sh updated for wired RPCs, Justfile chaos recipes, weekly-chaos.yml wiring)
>
