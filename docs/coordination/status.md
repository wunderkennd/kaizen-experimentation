...
|-------|--------|--------|----------------|-------------------|------------|-------|
| Agent-1 | M1 Assignment | 🔵 In Progress | agent-1/feat/targeting-rules | Layer-aware + session-level assignment (1.5) | — | M1.1, M1.2, M1.4 complete. Next: layer-aware assignment. |
