...
| **UX design** (M6-touching work) | What states, flows, and a11y acceptance before build? | UX spec → `docs/superpowers/specs/YYYY-MM-DD-<slug>-ux.md` alongside the technical spec | `docs/templates/ux-spec-template.md` | States enumeration incl. empty/loading/error (Palette standards); checkable a11y acceptance |
