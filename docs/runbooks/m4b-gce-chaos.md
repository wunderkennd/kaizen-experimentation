...
> [`.github/workflows/weekly-chaos-gcp.yml`](../ci/weekly-chaos-gcp.yml) because the
> #501 worker's GitHub App lacks the `workflows` permission. A maintainer
> lands it with:
> `git mv .github/workflows/weekly-chaos-gcp.yml .github/workflows/weekly-chaos-gcp.yml`
