      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          {loading && experiments.length > 0 && (
            <div className="flex items-center gap-2 text-sm text-gray-500" role="status" data-testid="refreshing-indicator">
              <svg className="h-4 w-4 animate-spin text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true">
