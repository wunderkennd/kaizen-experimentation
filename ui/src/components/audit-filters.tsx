    ...
    <div className="mb-4 flex flex-wrap items-center gap-3">
      ...
      <div className="group relative flex-1 min-w-[200px] max-w-sm">
        ...
        <input
          ...
          className="peer w-full rounded-md border border-gray-300 py-1.5 pl-9 pr-10 text-sm placeholder:text-gray-400 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
      ...
      <div className="group relative max-w-[200px]">
        ...
        {actorQuery && (
          <button
            ...
            data-testid="clear-actor-search-button"
          >
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
            </svg>
